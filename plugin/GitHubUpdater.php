...
class GitHubUpdater
{
     ...
     *
     * @var string .../wp-content/plugins/plugin-updater/d365popup-manger.php
     */
    private string $file = '.../wp-content/plugins/plugin-updater/d365popup-manger.php';
     ...
     */
    private string $gitHubUrl = 'https://github.com/Ujjawal-bh/plugin-updater';
     ...
     */
    private string $gitHubPath = 'Ujjawal-bh/plugin-updater';
     ...
     */
    private string $gitHubOrg = 'Ujjawal-bh';
     ...
     */
    private string $gitHubRepo = 'plugin-updater';
     ...
     */
    private string $gitHubAccessToken = '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';
     ...
     */
    private string $pluginFile = 'plugin-updater/d365popup-manger.php';
     ...
     * @var string github-updater-demo
     */
    private string $pluginDir = 'plugin-updater';
     ...
     */
    private string $pluginFilename = 'd365popup-manger.php';
     ...
     * @var string ryansechrest-github-updater-demo
     */
    private string $pluginSlug = 'd365popup-manager';
     ...
     * @var string https://github.com/ryansechrest/github-updater-demo
     */
    private string $pluginUrl = 'https://github.com/Ujjawal-bh/plugin-updater';
     ...
     * @var string 1.0.0
     */
    private string $pluginVersion = '1.0.1';
